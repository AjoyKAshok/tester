...
class _EditLeaveRulesState extends State<EditLeaveRules> {
  TextEditingController leavetype = TextEditingController(
      text: leaverules.leavetype[selectindexofleaverule].toString());
  TextEditingController totaldays = TextEditingController(
      text: leaverules.total_days_count[selectindexofleaverule].toString());
  TextEditingController remarks = TextEditingController(
      text: leaverules.remarks[selectindexofleaverule].toString());
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Center(
                            child: Text(
                          "${leaverules.leavetype[selectindexofleaverule]} ",
                          style: TextStyle(fontSize: 16),
                        )),
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: GestureDetector(
                        onTap: () async {
                          updateleaverule.leaveid =
                              leaverules.leaveid[selectindexofleaverule];
