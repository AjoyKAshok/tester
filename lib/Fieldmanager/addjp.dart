                            ...
                            children: <Widget>[
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      if (value.length > 0) {
                                        ...
                                        print('The selected value : $value');
                                      } else {
                                        selectedoutlets = null;
                                      }
                                      print(
                                          'The Selected Outlet Number is: ${selectedoutlets.length}');
                                    });
                                  },
                              ...
                              Align(
                                ...
                                child: GestureDetector(
                                    onTap: () async {
                                      print(
                                          'Schedule is Pressed: $pressschdlue');
                                      addunschdulejp.outletid = [];
                                      addschdulejp.outletid = [];
                                      addschdulejp.days = [];
                                      print(
                                          "selectedmonth...$selectedmonth..selectedweekday...$selectedweekday");
                                      if (pressschdlue == true) {
                                        ...
                                        if (selectedoutlets != null &&
                                          ...
                                          for (int u = 0;
                                            ...
                                            print(
                                                'Outlet Name : ${outletdata.outletname[selectedoutlets[u]]}');
                                            print(
                                                'Outlet Id : ${outletdata.outletid[selectedoutlets[u]]}');
                                          }
...
class _journeyplanDetailsState extends State<journeyplanDetails> {
  removeJp(BuildContext context, int index) {
                      ...
                      child: SizedBox(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                "Are you sure that you want to Delete this TimeSheet?",
                                    ...
                                    itemBuilder:
                                      ...
                                      return GestureDetector(
                                        onLongPress: () {
                                          ...
                                          //                                     height: 15.00,
                                          //                                   ),
                                          //                                   Text("Are you sure that you want to Delete this TimeSheet?",
                                          //                                       style: TextStyle(fontSize: 14)),
                                          //                                   SizedBox(
                                          //                                     height: 25.00,
                                          //                                   ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Text("Are you sure that you want to Delete this TimeSheet?", style: TextStyle(fontSize: 14)),
                                                                                  SizedBox(
                                                                                    height: 25.00,
                                                                                  ),
                                                                                  Row(
                                                                                    ...
                                                                                    children: [
                                                                                      GestureDetector(
                                                                                        ...
                                                                                        child: Container(
                                                                                          ...
                                                                                          margin: EdgeInsets.only(right: 10.00),
                                                                                          child: Center(child: Text("Yes Please")),
                                                                                        ),
                                                                                      ),
                                                                                    ],
                                                                                  ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Text("Are you sure do you want to Delete this TimeSheet?", style: TextStyle(fontSize: 14)),
                                                                                  SizedBox(
                                                                                    height: 25.00,
                                                                                  ),
                                                                                  Row(
