                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () async {
                          print("start date...${DateFormat("yyyy-MM-dd")
                              .format(DateTime.now())}");
                          if (merchandiser == null) {
                            ...
                            Flushbar(
                              message: "Please select Field Manager",
                              duration: Duration(seconds: 3),
                            )..show(context);
                          } else {
                            setState(() {
                            ...
                            print(
                                'RMS${merchandiser.replaceAll(new RegExp(r'[^0-9]'), '')}');
                            print(
                                'RMS${cde.replaceAll(new RegExp(r'[^0-9]'), '')}');
                            Addrepcdedata.cdeid =
                                'RMS${cde.replaceAll(new RegExp(r'[^0-9]'), '')}';
                            Addrepcdedata.merchandiserid =
                                'RMS${merchandiser.replaceAll(new RegExp(r'[^0-9]'), '')}';
                            Addrepcdedata.startdate =
                                pickeddate.startdate == null
