...
class _AddPromotionState extends State<AddPromotion> {
  ...
  Widget build(BuildContext context) {
    ...
    AddPromo.outletid = outletdata.outletid[
    outletdata.outletname
        .indexOf(SelectedOutlet)];
    AddPromo.productid = [];
    AddPromo.imgurl = [];
    for (int u = 0; u < selectbrands.length; u++) {
    AddPromo.productid.add(
    productlist.productid [selectbrands[u]]);
    AddPromo.imgurl.add(
    'data:image/jpeg;base64,${pickedfile.bytes[u]}');
    }
    AddPromo.fromdate =
