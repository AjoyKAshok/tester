...
List<String> logtime = [];
String appversionnumber = "4.4.14";
...
class LinearProgressIndicatorWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LinearProgressIndicator(
      ...
      semanticsLabel:
          'Primary: $completedPercentage%, Secondary: $incompletePercentage%',
      semanticsValue:
          '${completedPercentage.round()}%, ${incompletePercentage.round()}%',
    );
  }
}

String outletid = chekinoutlet.checkinoutletid;
String idOut = chekinoutlet.checkinoutlet;
          ...
          child: Row(
            children: [
              Text(
                ...
                style: TextStyle(fontSize: 8.0, color: Color(0XFF909090)),
              ),
