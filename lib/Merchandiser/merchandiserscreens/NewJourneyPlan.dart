...
class NewJourneyPlanPage extends StatefulWidget {
  @override
  _NewJourneyPlanPageState createState() => _NewJourneyPlanPageState();
}

class _NewJourneyPlanPageState extends State<NewJourneyPlanPage> {
  ...
  loadValues() async {
    ...
    /// WORK IN THE GETTODAYJP.STATUS VALUE TO ENABLE THE DIALOG BOX REDIRECTING THE USER TO THE UNFINISHED OUTLET IF THEY NAVIGATE BACK TO JOURNEY PLAN PAGE FROM ACTIVITIES PAGE
    // print('${gettodayjp.status.length}');
    // for (int u = 0; u < gettodayjp.status.length; u++) {
    //   if (gettodayjp.status[u] == AppConstants.working) {
    //     workingidnew = await gettodayjp.id[u];
    ...
    //                                     currentoutletid;
    //                                 checkinoutdata.checkid = workingidnew;
    //                                 currenttimesheetid = workingidnew;
...
class _State extends State<JourneyListBuilder> {
  ...
  //   super.initState();
  // }
  /// FOR IMPLEMENTING SEPARATE ICON FOR SPLIT SHIFT.
  // checkSplitShift(dynamic normalcheckouttime, dynamic normalcheckintime,
  //     dynamic splitshiftcheckintime) async {
  //   bool valSplit;
  //   DateFormat df = new DateFormat('HH:mm:ss');
  //   var currentTime = DateTime.now();
  //   var splitCheckinTime = df.format(currentTime);
  //   print('The Present Time is: $splitCheckinTime');
  //   for (int u = 0; u < gettodayjp.storenames.length; u++) {
  //     // valSplit = gettodayjp.splitOutlet[u];
  //     print(
  //         'The values of status = ${gettodayjp.status[u]}, checkouttime = $normalcheckouttime, split checkin time : $splitshiftcheckintime');
  //     if (gettodayjp.status[u] == 'done') {
  //       print('The Store is Already Visited');
  //       if (normalcheckouttime != null) {
  //         if (splitshiftcheckintime != null &&
  //             splitshiftcheckintime != normalcheckintime) {
  //           valSplit = true;
  //         } else {
  //           valSplit = false;
  //         }
  ...
  //       }
  //       print(
  //           'The Store Name is ${gettodayjp.storenames[u]} and Split Shift Value is $valSplit');
  //     }
  //   }
  // }
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (gettodayjp.status[index] == 'done') {
                      ...
                      /// COMMENTED OUT THE BELOW PORTION TO AVOID THE SYNC_MSG
                      ...
                      //   print(
                      //       'The current outlet index is : $currentoutletindex');
                      ...
                      //           .center,
                      //   children: [
                      /// SPLIT SHIFT FROM CONTAINER DE-ACTIVATED
                      // GestureDetector(
                      //   onTap: () async {
                      //   print("check445");
...
// print('Split Shift Value : ${gettodayjp.splitOutlet[index]}');
                      ...
                      //   if (onlinemode.value) {
                      //     print("check41");
                      //     print('The online mode value : ${onlinemode.value}');
                      //     showDialog(
                      //         context: context,
                      //         builder: (_) =>
                      //             StatefulBuilder(builder: (context, setState) {
                      ...
                      //                         ),
                      //                         Text(
                      //                           "We found some activites that need to be synced, please sync it and try again.",
                      //                           textAlign: TextAlign.center,
                      //                         ),
                      //                         SizedBox(
                      //                           height: 10,
