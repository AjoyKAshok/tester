                      ...
                      builder: (context) {
                        ...
                        return Column(
                          ...
                          children: [
                            Text(
                              greetingMessage(),
                              style: TextStyle(color: Color(0XFFE84201), fontSize: 20),
                            ),
                            Divider(
                              color: Colors.black,
                            ),
                            ...
                            Text(
                              ...
                              textAlign: TextAlign.center,
                              style: TextStyle(color: Color(0XFFE84201), fontSize: 14),
                            ),
                            //SizedBox(height: 5,),
                            synctime != null
                                ? Padding(
                                    ...
                                    child: Text(
                                      ...
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          color: Color(0XFFE84201), fontSize: 10),
                                    ))
                                : SizedBox(),
                            Row(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              setState(() {
                                ...
                                workingEffectiveMTB =  "${DBResponsedatadaily.EffectiveTime}" == '0'
                                    ? '0'
                                    :  "${DBResponsedatamonthly.WorkingTime}"
                                        '/'
                                        "${DBResponsedatamonthly.EffectiveTime}";
                                ...
                                workingEffectiveDaily =  "${DBResponsedatadaily.EffectiveTime}" == '0'
                                    ? '0'
                                    :  "${DBResponsedatadaily.WorkingTime}" '/'  "${DBResponsedatadaily.EffectiveTime}";
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text('Activity Performance', style: TextStyle(
                                    fontSize: 17, color: Color(0XFF909090)),),
                            ),
                            Container(
                              height: 208,
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  children: [
                                    ...
                                    //             left: 21.0,
                                    //           ),
                                    //           child: makeLeaveDashboardItem(
                                    //               'Available Leaves',
                                    //               DBResponsedatamonthly
                                    //                   .leavebalance
                                    //                   .toString(),
                                    //               Icons.person,
                                    //               0XFFE84201,
                            ...
                            /// THE BELOW CODE IS COMMENTED OUT AS THE DETAILS HAS BEEN MOVED OUT TO TRAVEL PLAN SECTION IN NEW DESIGN
                            // Column(
                            //   children: [
                            // GestureDetector(
                            //   onTap: () {},
