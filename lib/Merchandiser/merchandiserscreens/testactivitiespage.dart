...
class TestActivitiesPage extends StatefulWidget {
  const TestActivitiesPage({ Key key }) : super(key: key);

  @override
  State<TestActivitiesPage> createState() => _TestActivitiesPageState();
}

class _TestActivitiesPageState extends State<TestActivitiesPage> {
 showAlert() {
    showDialog(
